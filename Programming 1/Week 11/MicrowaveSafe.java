// file: MicrowaveSafe.java
// generated by: mashc
// from: MicrowaveSafe.mash

public class MicrowaveSafe extends MicrowaveSafe$SUPER {
...
protected static final int LAMP = B;

protected static final int DISH = A;
...
{
mash_nxt_setUpSensor(MicrowaveSafe.BUTTON, TOUCH);
mash_nxt_setUpSensor(MicrowaveSafe.CLOSED, TOUCH);
MicrowaveSafe.microwave();
}
} // end of main method


protected static void microwave()  {
mash_nxt_thread1.start();;
while (true)
{
if (MicrowaveSafe.timer > 0 && mash_nxt_isPushed(MicrowaveSafe.CLOSED))
{
MicrowaveSafe.light();
MicrowaveSafe.on();
timer = MicrowaveSafe.timer - 1;
mash_sleep(100);
if (MicrowaveSafe.timer == 0)
{
MicrowaveSafe.tune();
}
}
...
private static class MaSH_NXT_Thread1 extends Thread {
               public void run() {
                  mash_nxt_run1();
               }
            }
            
            private static MaSH_NXT_Thread1 mash_nxt_thread1 = 
               new MaSH_NXT_Thread1();
               
            private static void mash_nxt_run1() {
{
while (true)
{
mash_nxt_waitForPush(MicrowaveSafe.BUTTON);
mash_sleep(100);
timer = MicrowaveSafe.timer + 50;
...
protected static void dark()  {
mash_nxt_whichMotorPort(MicrowaveSafe.LAMP).stop();
}

protected static void light()  {
mash_nxt_motorForward(MicrowaveSafe.LAMP, 100);
}

protected static void on()  {
mash_nxt_motorBackward(MicrowaveSafe.DISH, 50);
}

protected static void off()  {
mash_nxt_whichMotorPort(MicrowaveSafe.DISH).stop();
}

protected static void tune()  {
lejos.nxt.Sound.playTone(200, 500);
mash_sleep(100);
lejos.nxt.Sound.playTone(300, 500);
mash_sleep(100);
lejos.nxt.Sound.playTone(100, 500);
mash_sleep(100);
lejos.nxt.Sound.playTone(200, 500);
mash_sleep(100);
lejos.nxt.Sound.playTone(300, 500);

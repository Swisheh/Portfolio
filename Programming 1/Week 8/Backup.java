...
public class Backup extends Backup$SUPER {
...
{
mash_nxt_setUpSensor(Backup.TOU, TOUCH);
while (true)
{
Backup.go();
if (mash_nxt_isPushed(Backup.TOU))
{
Backup.backward();
mash_sleep(Backup.getRandom());
Backup.turn();
mash_sleep(Backup.getRandom());
}
}
...
mash_nxt_motorBackward(Backup.MOT1, 100);
mash_nxt_motorBackward(Backup.MOT2, 100);
}

protected static void backward()  {
mash_nxt_motorForward(Backup.MOT1, 100);
mash_nxt_motorForward(Backup.MOT2, 100);
}

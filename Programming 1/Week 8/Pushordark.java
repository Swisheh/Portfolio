// file: Pushordark.java
// generated by: mashc
// from: Pushordark.mash

public class Pushordark extends Pushordark$SUPER {
...
protected static final int MOT1 = A;

protected static final int MOT2 = C;

protected static final int LIG = 2;

protected static final int TOU = 1;
...
{
mash_nxt_setUpSensor(Pushordark.TOU, TOUCH);
mash_nxt_setUpSensor(Pushordark.LIG, LIGHT_FLOOD);
mash_sleep(500);
int i = 0;
Pushordark.go();
while (! mash_nxt_isPushed(Pushordark.TOU) && i == 0)
{
if (mash_nxt_isPushed(Pushordark.TOU))
{
Pushordark.stop();
i = i + 1;
}
int darker = mash_nxt_getLight(Pushordark.LIG);
if (darker < 50)
{
Pushordark.stop();
i = i + 1;
...
mash_nxt_motorBackward(Pushordark.MOT1, 100);
mash_nxt_motorBackward(Pushordark.MOT2, 100);
}

protected static void stop()  {
mash_nxt_whichMotorPort(Pushordark.MOT1).stop();
mash_nxt_whichMotorPort(Pushordark.MOT2).stop();
}
} // end of the program class
         
         class Pushordark$SUPER {

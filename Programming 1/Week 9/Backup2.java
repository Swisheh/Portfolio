...
public class Backup2 extends Backup2$SUPER {
...
{
mash_nxt_setUpSensor(Backup2.TOU, TOUCH);
mash_nxt_setUpSensor(Backup2.LIG, LIGHT_FLOOD);
while (true)
{
Backup2.go();
if (mash_nxt_isPushed(Backup2.TOU))
{
Backup2.backward();
mash_sleep(Backup2.getRandom());
Backup2.turn();
mash_sleep(Backup2.getRandom());
}
else
if (mash_nxt_getLight(Backup2.LIG) < 50)
{
Backup2.backward();
mash_sleep(Backup2.getRandom());
Backup2.turn();
...
mash_nxt_motorBackward(Backup2.MOT1, 100);
mash_nxt_motorBackward(Backup2.MOT2, 100);
}

protected static void backward()  {
mash_nxt_motorForward(Backup2.MOT1, 100);
mash_nxt_motorForward(Backup2.MOT2, 100);
}
...
double x = java.lang.Math.random() * 2000;
int l = (int) x;
return l;
}

...
public class Rotation extends Rotation$SUPER {
...
mash_sleep(500);
mash_nxt_resetRotation(A);
mash_nxt_motorBackward(A, 60);
mash_nxt_waitForDarker(2, 10);
int rot = mash_nxt_getRotation(A);
mash_nxt_motorForward(A, 60);
mash_nxt_waitForRotation(A, rot);
mash_nxt_whichMotorPort(A).stop();
} // end of main method

} // end of the program class
         
         class Rotation$SUPER {

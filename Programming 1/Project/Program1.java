...
public class Program1 extends Program1$SUPER {
...
protected static int dpow = 100;

protected static int upow = 100;
...
{
mash_nxt_setUpSensor(Program1.TOP, TOUCH);
mash_nxt_setUpSensor(Program1.BOT, TOUCH);
while (true)
{
if (mash_nxt_isPushed(Program1.TOP))
{
}
if (mash_nxt_isPushed(Program1.BOT))
{
}
}
}
...
mash_nxt_motorBackward(Program1.LIFT, Program1.upow);
}

protected static void down()  {
mash_nxt_motorForward(Program1.LIFT, Program1.dpow);
}

protected static void stop()  {
mash_nxt_whichMotorPort(Program1.LIFT).stop();
}

protected static void open()  {
mash_nxt_motorBackward(Program1.DOOR, 100);
}

protected static void close()  {
mash_nxt_motorForward(Program1.DOOR, 100);
}

protected static void stop2()  {
mash_nxt_whichMotorPort(Program1.DOOR).stop();
}
} // end of the program class
         
         class Program1$SUPER {

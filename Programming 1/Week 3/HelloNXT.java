...
public class HelloNXT extends HelloNXT$SUPER {
...
mash_nxt_setUpSensor(4, TOUCH);
lejos.nxt.LCD.drawString("+--------------+", 0, 3);
lejos.nxt.LCD.drawString("|  Hello, NXT. |", 0, 4);
lejos.nxt.LCD.drawString("+--------------+", 0, 5);
mash_nxt_waitForPush(4);
} // end of main method

} // end of the program class
         
         class HelloNXT$SUPER {
